...
public class WeightedSubstring {
    ...
    public static void runExperiments() {
        ...
        WeightedSubstring ws1 = new WeightedSubstring(1, 10.0);
        ...
        // Scenario 1: w[i] = 1 for all i, p = 10
        System.out.println("\n\n=== SCENARIO 1: Uniform weights (w=1), penalty=10 ===");
        runScenario(1, 10.0, 1.0, 1.0);

        // Scenario 2: Weights proportional to English frequency, p = 10
        System.out.println("\n\n=== SCENARIO 2: Weights proportional to English frequency ===");
        ...
        for (int i = 0; i <= 10; i++) {
            ...
            System.out.printf("\nWeight range [%.1f, %.1f]:\n", minWeight, maxWeight);
            runScenario(2, 10.0, minWeight, maxWeight);
        }
    }
